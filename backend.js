...
var exports = {
    ...
    // 直接点击开始番茄按钮，通过data里面的设置来设定状态
    clockOperation4page: function (page, callback) {
        wx.request({
            url: config.service.createTomatoUrl,
            data: {
                'session': wx.getStorageSync('session'),
                'invite': wx.getStorageSync('invite'),
                'doTime': page.data['tomatoTime'],
                'restTime': page.data['restTime'],
                'todoForm': page.data['todoForm']
            },
            header: {
                'content-type': 'application/json'
            },
    ...
    // 一个用来同步时间的
    updateOperation: function () {//TODO 同步时间还没做
        wx.request({
    ...
    pauseOperation4page: function (page, callback) {
        wx.request({
            url: config.service.pauseTomatoUrl,
            data: {
                'session': wx.getStorageSync('session'),
    ...
    stopOperation4page: function (page, callback) {
        wx.request({
            url: config.service.stopTomatoUrl,
            data: {
                'session': wx.getStorageSync('session'),
